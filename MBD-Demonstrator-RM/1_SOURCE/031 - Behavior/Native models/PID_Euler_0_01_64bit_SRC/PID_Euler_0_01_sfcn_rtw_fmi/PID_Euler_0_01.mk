...
MODEL              = PID_Euler_0_01
MODULES            = PID_Euler_0_01_sf_data.c rtGetInf.c rtGetNaN.c 
MAKEFILE           = PID_Euler_0_01.mk
MATLAB_ROOT        = /usr/local/MATLAB/R2016b
ALT_MATLAB_ROOT    = /usr/local/MATLAB/R2016b
MASTER_ANCHOR_DIR  = 
START_DIR          = /home/ines/Desktop/PID_Euler_0_001_64bit
S_FUNCTIONS        = 
S_FUNCTIONS_LIB    = 
SOLVER             = ode1.c
NUMST              = 2
...
COMPUTER           = GLNXA64
MEXEXT             = mexa64
BUILDARGS          =  MODELLIB=PID_Euler_0_01lib.a RELATIVE_PATH_TO_ANCHOR=.. MODELREF_TARGET_TYPE=NONE ISPROTECTINGMODEL=NOTPROTECTING
USERMODULES        =  
CREATEMODEL        = 0
USEPARAMVALUES     = 0
PURIFY             = 0
...
ADD_INCLUDES = \
	-I$(START_DIR)/PID_Euler_0_01_sfcn_rtw_fmi \
	-I$(START_DIR) \
	-I/home/ines/Desktop \
...
FMI_OBJS = $(FMI_SOLVER_OBJ) $(FMI_RT_OBJS) $(FMI_SFCN_OBJS) $(FMI_MODULE_OBJS) $(LOCAL_USER_OBJS) $(FMI_OBJ)
...
FMI_EXT = so
FMI_LD  = gcc
FMI_LD_CMD = -shared -fPIC $(FMI_ARCH_OPT) $(FMI_OBJS) $(FMI_IMPL) $(LIBS)
ifeq ($(FMI_LOAD_MEX),1)
